 ...
 * @author lkroll
 */
class StatementScope extends Scope implements Scope.Labelled, Scope.Fieldy {
    
    private final HashMap<String, Field> variables = new HashMap<>();
    private final Map<String, JLabel> labels = new HashMap<>();

    StatementScope(Scope parent) {
        super(parent);
    }
    ...
    public JLabel resolveLabel(String name) {
        ...
        if (l != null) {
            ...
            return parent().resolveLabel(name);
        }
    }
