...
public final class AAssignmentAssignmentExpressionNoName extends PAssignmentExpressionNoName
{
    private PAssignment _assignment_;

    public AAssignmentAssignmentExpressionNoName()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AAssignmentAssignmentExpressionNoName(
    ...
    {
        ((Analysis) sw).caseAAssignmentAssignmentExpressionNoName(this);
    }
