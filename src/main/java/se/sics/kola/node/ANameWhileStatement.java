...
public final class ANameWhileStatement extends PWhileStatement
{
    ...
    public Object clone()
    {
        return new ANameWhileStatement(
    ...
    {
        ((Analysis) sw).caseANameWhileStatement(this);
    }
