...
public final class AExpressionArgument extends PArgument
{
    private PExpressionNoName _expressionNoName_;

    public AExpressionArgument()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AExpressionArgument(
    ...
    {
        ((Analysis) sw).caseAExpressionArgument(this);
    }
