...
public final class ALtExpressionNoName extends PExpressionNoName
{
    private PExpression _left_;
    private PExpression _right_;

    public ALtExpressionNoName()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ALtExpressionNoName(
    ...
    {
        ((Analysis) sw).caseALtExpressionNoName(this);
    }
