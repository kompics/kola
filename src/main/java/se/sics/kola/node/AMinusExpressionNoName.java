...
public final class AMinusExpressionNoName extends PExpressionNoName
{
    private PExpression _left_;
    private PExpression _right_;

    public AMinusExpressionNoName()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AMinusExpressionNoName(
    ...
    {
        ((Analysis) sw).caseAMinusExpressionNoName(this);
    }
