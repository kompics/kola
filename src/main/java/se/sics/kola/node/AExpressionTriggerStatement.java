...
public final class AExpressionTriggerStatement extends PTriggerStatement
{
    ...
    public AExpressionTriggerStatement()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AExpressionTriggerStatement(
    ...
    {
        ((Analysis) sw).caseAExpressionTriggerStatement(this);
    }
