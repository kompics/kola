...
public final class ANameForStatementNoShortIf extends PForStatementNoShortIf
{
    ...
    public ANameForStatementNoShortIf()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ANameForStatementNoShortIf(
    ...
    {
        ((Analysis) sw).caseANameForStatementNoShortIf(this);
    }
