...
public final class ANameBasicForStatement extends PBasicForStatement
{
    ...
    public Object clone()
    {
        return new ANameBasicForStatement(
    ...
    {
        ((Analysis) sw).caseANameBasicForStatement(this);
    }
