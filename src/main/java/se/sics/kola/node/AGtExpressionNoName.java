...
public final class AGtExpressionNoName extends PExpressionNoName
{
    private PExpression _left_;
    private PExpression _right_;

    public AGtExpressionNoName()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AGtExpressionNoName(
    ...
    {
        ((Analysis) sw).caseAGtExpressionNoName(this);
    }
