...
public final class AStaticComponentBodyDeclaration extends PComponentBodyDeclaration
{
    private PStaticInitializer _staticInitializer_;

    public AStaticComponentBodyDeclaration()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AStaticComponentBodyDeclaration(
    ...
    {
        ((Analysis) sw).caseAStaticComponentBodyDeclaration(this);
    }
