...
public final class AMulExpressionNoName extends PExpressionNoName
{
    private PExpression _left_;
    private PExpression _right_;

    public AMulExpressionNoName()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AMulExpressionNoName(
    ...
    {
        ((Analysis) sw).caseAMulExpressionNoName(this);
    }
