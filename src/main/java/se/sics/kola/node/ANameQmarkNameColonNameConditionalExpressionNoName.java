...
public final class ANameQmarkNameColonNameConditionalExpressionNoName extends PConditionalExpressionNoName
{
    private PName _name1_;
    private TQmark _qmark_;
    private PName _name2_;
    private TColon _colon_;
    private PName _name3_;

    public ANameQmarkNameColonNameConditionalExpressionNoName()
    {
        // Constructor
    }
    ...
    public ANameQmarkNameColonNameConditionalExpressionNoName(
        ...
        @SuppressWarnings("hiding") PName _name3_)
    {
        // Constructor
        setName1(_name1_);
    ...
    public Object clone()
    {
        return new ANameQmarkNameColonNameConditionalExpressionNoName(
            cloneNode(this._name1_),
            cloneNode(this._qmark_),
            cloneNode(this._name2_),
            cloneNode(this._colon_),
            cloneNode(this._name3_));
    }

    @Override
    public void apply(Switch sw)
    {
        ((Analysis) sw).caseANameQmarkNameColonNameConditionalExpressionNoName(this);
    }
    ...
    public PName getName3()
    {
        return this._name3_;
    }

    public void setName3(PName node)
    {
        if(this._name3_ != null)
        {
            this._name3_.parent(null);
        }
    ...
    void replaceChild(@SuppressWarnings("unused") Node oldChild, @SuppressWarnings("unused") Node newChild)
    {
        ...
        if(this._name3_ == oldChild)
        {
            setName3((PName) newChild);
            return;
        }
