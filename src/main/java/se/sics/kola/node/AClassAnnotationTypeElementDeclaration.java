...
public final class AClassAnnotationTypeElementDeclaration extends PAnnotationTypeElementDeclaration
{
    private PClassDeclaration _classDeclaration_;

    public AClassAnnotationTypeElementDeclaration()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AClassAnnotationTypeElementDeclaration(
    ...
    {
        ((Analysis) sw).caseAClassAnnotationTypeElementDeclaration(this);
    }
