...
public final class AUshrExpressionNoName extends PExpressionNoName
{
    private PExpression _left_;
    private PExpression _right_;

    public AUshrExpressionNoName()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AUshrExpressionNoName(
    ...
    {
        ((Analysis) sw).caseAUshrExpressionNoName(this);
    }
