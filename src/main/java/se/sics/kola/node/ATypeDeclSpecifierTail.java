...
public final class ATypeDeclSpecifierTail extends PTypeDeclSpecifierTail
{
    private PTypeArguments _typeArguments_;
    private TDot _dot_;
    private PName _name_;

    public ATypeDeclSpecifierTail()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ATypeDeclSpecifierTail(
    ...
    {
        ((Analysis) sw).caseATypeDeclSpecifierTail(this);
    }
