...
public final class AExpressionVariableInitializerNoName extends PVariableInitializerNoName
{
    private PExpressionNoName _expressionNoName_;

    public AExpressionVariableInitializerNoName()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AExpressionVariableInitializerNoName(
    ...
    {
        ((Analysis) sw).caseAExpressionVariableInitializerNoName(this);
    }
