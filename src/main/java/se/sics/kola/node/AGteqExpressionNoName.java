...
public final class AGteqExpressionNoName extends PExpressionNoName
{
    private PExpression _left_;
    private PExpression _right_;

    public AGteqExpressionNoName()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AGteqExpressionNoName(
    ...
    {
        ((Analysis) sw).caseAGteqExpressionNoName(this);
    }
