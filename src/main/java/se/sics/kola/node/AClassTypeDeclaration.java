...
public final class AClassTypeDeclaration extends PTypeDeclaration
{
    private PClassDeclaration _classDeclaration_;

    public AClassTypeDeclaration()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AClassTypeDeclaration(
    ...
    {
        ((Analysis) sw).caseAClassTypeDeclaration(this);
    }
