...
public final class AModExpressionNoName extends PExpressionNoName
{
    private PExpression _left_;
    private PExpression _right_;

    public AModExpressionNoName()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AModExpressionNoName(
    ...
    {
        ((Analysis) sw).caseAModExpressionNoName(this);
    }
