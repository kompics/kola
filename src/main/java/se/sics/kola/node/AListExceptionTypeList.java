...
public final class AListExceptionTypeList extends PExceptionTypeList
{
    private PExceptionTypeList _exceptionTypeList_;
    private TComma _comma_;
    private PExceptionType _exceptionType_;

    public AListExceptionTypeList()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AListExceptionTypeList(
    ...
    {
        ((Analysis) sw).caseAListExceptionTypeList(this);
    }
