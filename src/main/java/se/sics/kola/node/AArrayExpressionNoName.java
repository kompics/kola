...
public final class AArrayExpressionNoName extends PExpressionNoName
{
    private PArrayAccess _arrayAccess_;

    public AArrayExpressionNoName()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AArrayExpressionNoName(
    ...
    {
        ((Analysis) sw).caseAArrayExpressionNoName(this);
    }
