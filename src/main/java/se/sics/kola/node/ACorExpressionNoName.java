...
public final class ACorExpressionNoName extends PExpressionNoName
{
    private PExpression _left_;
    private PExpression _right_;

    public ACorExpressionNoName()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ACorExpressionNoName(
    ...
    {
        ((Analysis) sw).caseACorExpressionNoName(this);
    }
