...
public final class APlusExpressionNoName extends PExpressionNoName
{
    private PExpression _left_;
    private PExpression _right_;

    public APlusExpressionNoName()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new APlusExpressionNoName(
    ...
    {
        ((Analysis) sw).caseAPlusExpressionNoName(this);
    }
