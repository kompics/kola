...
public final class AShrExpressionNoName extends PExpressionNoName
{
    private PExpression _left_;
    private PExpression _right_;

    public AShrExpressionNoName()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AShrExpressionNoName(
    ...
    {
        ((Analysis) sw).caseAShrExpressionNoName(this);
    }
