...
public final class AInterfaceAnnotationTypeElementDeclaration extends PAnnotationTypeElementDeclaration
{
    private PInterfaceDeclaration _interfaceDeclaration_;

    public AInterfaceAnnotationTypeElementDeclaration()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AInterfaceAnnotationTypeElementDeclaration(
    ...
    {
        ((Analysis) sw).caseAInterfaceAnnotationTypeElementDeclaration(this);
    }
