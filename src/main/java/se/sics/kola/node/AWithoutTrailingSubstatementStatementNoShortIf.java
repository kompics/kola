...
public final class AWithoutTrailingSubstatementStatementNoShortIf extends PStatementNoShortIf
{
    private PStatementWithoutTrailingSubstatement _statementWithoutTrailingSubstatement_;

    public AWithoutTrailingSubstatementStatementNoShortIf()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AWithoutTrailingSubstatementStatementNoShortIf(
    ...
    {
        ((Analysis) sw).caseAWithoutTrailingSubstatementStatementNoShortIf(this);
    }
