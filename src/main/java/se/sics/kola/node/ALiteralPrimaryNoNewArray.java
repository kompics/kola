...
public final class ALiteralPrimaryNoNewArray extends PPrimaryNoNewArray
{
    private PLiteral _literal_;

    public ALiteralPrimaryNoNewArray()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ALiteralPrimaryNoNewArray(
    ...
    {
        ((Analysis) sw).caseALiteralPrimaryNoNewArray(this);
    }
