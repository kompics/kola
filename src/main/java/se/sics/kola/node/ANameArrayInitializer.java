...
public final class ANameArrayInitializer extends PArrayInitializer
{
    ...
    public Object clone()
    {
        return new ANameArrayInitializer(
    ...
    {
        ((Analysis) sw).caseANameArrayInitializer(this);
    }
