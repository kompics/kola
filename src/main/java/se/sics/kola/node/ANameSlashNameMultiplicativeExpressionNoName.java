...
public final class ANameSlashNameMultiplicativeExpressionNoName extends PMultiplicativeExpressionNoName
{
    private PName _name1_;
    private TSlash _slash_;
    private PName _name2_;

    public ANameSlashNameMultiplicativeExpressionNoName()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ANameSlashNameMultiplicativeExpressionNoName(
    ...
    {
        ((Analysis) sw).caseANameSlashNameMultiplicativeExpressionNoName(this);
    }
