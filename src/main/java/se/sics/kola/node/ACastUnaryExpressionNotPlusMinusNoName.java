...
public final class ACastUnaryExpressionNotPlusMinusNoName extends PUnaryExpressionNotPlusMinusNoName
{
    private PCastExpression _castExpression_;

    public ACastUnaryExpressionNotPlusMinusNoName()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ACastUnaryExpressionNotPlusMinusNoName(
    ...
    {
        ((Analysis) sw).caseACastUnaryExpressionNotPlusMinusNoName(this);
    }
