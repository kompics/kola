...
public final class ANeqExpressionNoName extends PExpressionNoName
{
    private PExpression _left_;
    private PExpression _right_;

    public ANeqExpressionNoName()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ANeqExpressionNoName(
    ...
    {
        ((Analysis) sw).caseANeqExpressionNoName(this);
    }
