...
public final class ACandExpressionNoName extends PExpressionNoName
{
    private PExpression _left_;
    private PExpression _right_;

    public ACandExpressionNoName()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ACandExpressionNoName(
    ...
    {
        ((Analysis) sw).caseACandExpressionNoName(this);
    }
