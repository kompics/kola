...
public final class AIndicationDeclaration extends PIndicationDeclaration
{
    private PClassType _classType_;

    public AIndicationDeclaration()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AIndicationDeclaration(
    ...
    {
        ((Analysis) sw).caseAIndicationDeclaration(this);
    }
