...
public final class AEorExpressionNoName extends PExpressionNoName
{
    private PExpression _left_;
    private PExpression _right_;

    public AEorExpressionNoName()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AEorExpressionNoName(
    ...
    {
        ((Analysis) sw).caseAEorExpressionNoName(this);
    }
