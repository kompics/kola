...
public final class ALteqExpressionNoName extends PExpressionNoName
{
    private PExpression _left_;
    private PExpression _right_;

    public ALteqExpressionNoName()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ALteqExpressionNoName(
    ...
    {
        ((Analysis) sw).caseALteqExpressionNoName(this);
    }
