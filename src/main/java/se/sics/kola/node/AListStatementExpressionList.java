...
public final class AListStatementExpressionList extends PStatementExpressionList
{
    private PStatementExpressionList _statementExpressionList_;
    private TComma _comma_;
    private PStatementExpression _statementExpression_;

    public AListStatementExpressionList()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AListStatementExpressionList(
    ...
    {
        ((Analysis) sw).caseAListStatementExpressionList(this);
    }
