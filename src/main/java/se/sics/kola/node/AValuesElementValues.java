...
public final class AValuesElementValues extends PElementValues
{
    private PElementValues _elementValues_;
    private TComma _comma_;
    private PElementValue _elementValue_;

    public AValuesElementValues()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AValuesElementValues(
    ...
    {
        ((Analysis) sw).caseAValuesElementValues(this);
    }
