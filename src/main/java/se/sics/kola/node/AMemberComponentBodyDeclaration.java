...
public final class AMemberComponentBodyDeclaration extends PComponentBodyDeclaration
{
    private PClassMemberDeclaration _classMemberDeclaration_;

    public AMemberComponentBodyDeclaration()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AMemberComponentBodyDeclaration(
    ...
    {
        ((Analysis) sw).caseAMemberComponentBodyDeclaration(this);
    }
