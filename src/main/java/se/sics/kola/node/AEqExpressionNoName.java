...
public final class AEqExpressionNoName extends PExpressionNoName
{
    private PExpression _left_;
    private PExpression _right_;

    public AEqExpressionNoName()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AEqExpressionNoName(
    ...
    {
        ((Analysis) sw).caseAEqExpressionNoName(this);
    }
