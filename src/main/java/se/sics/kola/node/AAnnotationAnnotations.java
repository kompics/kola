...
public final class AAnnotationAnnotations extends PAnnotations
{
    private PAnnotation _annotation_;

    public AAnnotationAnnotations()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AAnnotationAnnotations(
    ...
    {
        ((Analysis) sw).caseAAnnotationAnnotations(this);
    }
