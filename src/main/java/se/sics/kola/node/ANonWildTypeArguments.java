...
public final class ANonWildTypeArguments extends PNonWildTypeArguments
{
    private TLt _lt_;
    private PReferenceTypeList _referenceTypeList_;
    private TGt _gt_;

    public ANonWildTypeArguments()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ANonWildTypeArguments(
            cloneNode(this._lt_),
    ...
    {
        ((Analysis) sw).caseANonWildTypeArguments(this);
    }
