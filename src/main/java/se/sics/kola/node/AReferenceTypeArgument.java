...
public final class AReferenceTypeArgument extends PTypeArgument
{
    private PReferenceType _referenceType_;

    public AReferenceTypeArgument()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AReferenceTypeArgument(
    ...
    {
        ((Analysis) sw).caseAReferenceTypeArgument(this);
    }
