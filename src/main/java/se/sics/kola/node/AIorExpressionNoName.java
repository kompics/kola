...
public final class AIorExpressionNoName extends PExpressionNoName
{
    private PExpression _left_;
    private PExpression _right_;

    public AIorExpressionNoName()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AIorExpressionNoName(
    ...
    {
        ((Analysis) sw).caseAIorExpressionNoName(this);
    }
