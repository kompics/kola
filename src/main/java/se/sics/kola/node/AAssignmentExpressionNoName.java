...
public final class AAssignmentExpressionNoName extends PExpressionNoName
{
    private PLeftHandSide _leftHandSide_;
    private PAssignmentOperator _assignmentOperator_;
    private PExpression _expression_;

    public AAssignmentExpressionNoName()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AAssignmentExpressionNoName(
    ...
    {
        ((Analysis) sw).caseAAssignmentExpressionNoName(this);
    }
