...
public final class AQmarkColonConditionalExpressionNoName extends PConditionalExpressionNoName
{
    ...
    public AQmarkColonConditionalExpressionNoName()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AQmarkColonConditionalExpressionNoName(
    ...
    {
        ((Analysis) sw).caseAQmarkColonConditionalExpressionNoName(this);
    }
