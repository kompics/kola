...
public final class AConstantExpressionNoName extends PConstantExpressionNoName
{
    private PExpressionNoName _expressionNoName_;

    public AConstantExpressionNoName()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AConstantExpressionNoName(
    ...
    {
        ((Analysis) sw).caseAConstantExpressionNoName(this);
    }
