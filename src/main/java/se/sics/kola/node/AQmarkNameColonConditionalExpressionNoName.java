...
public final class AQmarkNameColonConditionalExpressionNoName extends PConditionalExpressionNoName
{
    ...
    public AQmarkNameColonConditionalExpressionNoName()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AQmarkNameColonConditionalExpressionNoName(
    ...
    {
        ((Analysis) sw).caseAQmarkNameColonConditionalExpressionNoName(this);
    }
