...
public final class AShlExpressionNoName extends PExpressionNoName
{
    private PExpression _left_;
    private PExpression _right_;

    public AShlExpressionNoName()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AShlExpressionNoName(
    ...
    {
        ((Analysis) sw).caseAShlExpressionNoName(this);
    }
