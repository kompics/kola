...
public final class AIncrementUnaryExpressionNoName extends PUnaryExpressionNoName
{
    private PPreIncrementExpression _preIncrementExpression_;

    public AIncrementUnaryExpressionNoName()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AIncrementUnaryExpressionNoName(
    ...
    {
        ((Analysis) sw).caseAIncrementUnaryExpressionNoName(this);
    }
