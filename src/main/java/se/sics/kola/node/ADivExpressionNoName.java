...
public final class ADivExpressionNoName extends PExpressionNoName
{
    private PExpression _left_;
    private PExpression _right_;

    public ADivExpressionNoName()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ADivExpressionNoName(
    ...
    {
        ((Analysis) sw).caseADivExpressionNoName(this);
    }
