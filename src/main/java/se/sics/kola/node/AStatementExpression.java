...
public final class AStatementExpression extends PStatementExpression
{
    private PExpressionNoName _expressionNoName_;

    public AStatementExpression()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AStatementExpression(
    ...
    {
        ((Analysis) sw).caseAStatementExpression(this);
    }
